...
const names = ["tyriece", "bernice", "nick"];

const prices = ["$50", "$40", "$60"];

const occupations = ["photographer", "teacher", "military"];

const groups = [{ name: "nick", price: "$60", occupation: "military" }];
